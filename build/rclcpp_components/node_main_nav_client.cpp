...
#define NODE_MAIN_LOGGER_NAME "nav_client"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libtest_client.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<mynav::NavigationToPose>";
